...
class parallax_test:
    ...
    def layer_image_transform(self, image, frames, x, y, scale, aspect_ratio,):
...
NODE_CLASS_MAPPINGS = {"ParallaxTest": parallax_test}

NODE_DISPLAY_NAME_MAPPINGS = {"ParallaxTest": "Parallax Test"}